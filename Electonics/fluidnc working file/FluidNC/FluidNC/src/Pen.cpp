...
void initialize_pen_positions() {
    // Initialize hardcoded pen positions
    // Format: X, Y, Z, occupied
    pen_positions[0] = { 10.0f, 0.0f, 0.0f, true };    // Pen 1
    pen_positions[1] = { 30.0f, 0.0f, 0.0f, true };    // Pen 2
    ...
    pen_positions[7] = { 150.0f, 0.0f, 0.0f, true };   // Pen 8
    pen_positions[8] = { 170.0f, 0.0f, 0.0f, true };   // Pen 9
    pen_positions[9] = { 190.0f, 0.0f, 0.0f, true };   // Pen 10
}
